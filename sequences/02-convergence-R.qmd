...
$n\geq N:=\left\lceil\frac{2}{\varepsilon}\right\rceil$.[^1] 
...
[^1]:Here $\lceil\cdot\rceil$ denotes the ceiling function, $\lceil x\rceil:=\min \{k\in \mathbb{Z}: k\geq x\}$.
...
As seen in @exr-sum, the formula can be proved by induction.
...
As seen in @exr-sum1, the formula can be proved by induction.
