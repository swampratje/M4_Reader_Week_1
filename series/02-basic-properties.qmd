...
Let $s_n=\displaystyle\sum_{k=0}^n a_k$. If $s_n\to S$, then also $s_{n+1}\to S$. Hence
$$
...
Let $\displaystyle\sum_{n=0}^\infty a_n$ and $\displaystyle\sum_{n=0}^\infty b_n$ converge with sums $S_a$ and $S_b$.
Then for any $c\in\mathbb{R}$:

1. $\displaystyle\sum_{n=0}^\infty (c a_n)$ converges and has sum $cS_a$;
2. $\displaystyle\sum_{n=0}^\infty (a_n\pm b_n)$ converges and has sum $S_a\pm S_b$.
